    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-black via-dark to-dark-surface">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center py-20">
        ...
        <RevealOnScroll delay={600}>
          ...
          {/* Social Proof */}
          <div className="flex flex-col items-center justify-center gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-dark bg-gray-700 flex items-center justify-center text-xs text-white overflow-hidden">
                  <img src={`https://i.pravatar.cc/100?img=${i + 10}`} alt="Student" className="w-full h-full object-cover" />
                </div>
              ))}
              <div className="w-10 h-10 rounded-full border-2 border-dark bg-primary flex items-center justify-center text-xs font-bold text-white">
                1k+
              </div>
            </div>
            <div className="flex items-center gap-2 text-gray-400 text-sm">
              ...
              <span>Bergabung dengan 1,000+ pembelajar lainnya</span>
            </div>
          </div>
        </RevealOnScroll>
