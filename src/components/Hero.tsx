      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center py-20">
        ...
        <RevealOnScroll delay={800}>
          <div className="mt-16 pt-12 border-t-2 border-dark-border/50 flex flex-wrap justify-center gap-10 text-gray-300 text-base font-semibold">
             <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-gradient-to-br from-dark-surface/60 to-dark/60 backdrop-blur-sm border border-dark-border/50 hover:border-primary/40 transition-all hover:shadow-lg hover:shadow-primary/10">
