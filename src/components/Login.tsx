...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark via-dark-surface to-dark relative overflow-hidden flex items-center justify-center">
      {/* Animated Background */}
          ...
          <div className="relative bg-gradient-to-br from-dark-surface/95 to-dark/95 backdrop-blur-xl p-10 rounded-3xl border-2 border-primary/30 shadow-2xl shadow-primary/20">
            ...
            <div className="text-center mb-8">
              <Link to="/" className="inline-flex items-center gap-3 mb-4">
                <img src="/valura_logo.png" alt="Valura Logo" className="h-12 w-12 rounded-full object-cover border-2 border-primary/50" />
                <h1 className="text-4xl font-bold text-white tracking-wider">
                  VALURA <span className="text-primary">CLUB</span>
                </h1>
              </Link>
              <p className="text-gray-300 text-lg">Selamat Datang Kembali</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-dark/50 border-2 border-dark-border rounded-xl text-white placeholder-gray-500 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-300 outline-none pr-12"
                    placeholder="••••••••"
                    required
                  />
                  <button
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input 
                    ...
                    className="w-4 h-4 rounded border-dark-border bg-dark/50 text-primary focus:ring-primary/20 cursor-pointer" 
                  />
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-primary via-secondary to-primary bg-size-200 bg-pos-0 hover:bg-pos-100 text-white font-bold py-4 rounded-xl transition-all duration-500 shadow-lg shadow-primary/30 hover:shadow-primary/50 hover:scale-[1.02] border-2 border-primary/50"
              >
                Masuk
              </button>
            </form>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-dark-surface text-gray-400">Atau lanjutkan dengan</span>
              </div>
            </div>
